	...
	$(function() {
		...
		var objCrm = {
			...
			update : function() {//修改
				...
				if (row) {
					systemDictionaryDlg.dialog('open').dialog('setTitle', '修改用户');
					// 部门经理
					//if (row.manager) {
...
<body>
	...
	<table id="systemDictionaryGrid" class="easyui-datagrid" title="部门管理"
		fit="true" url="/systemDictionary/json" pagination="true" rownumbers="true"
		singleSelect="true" toolbar="#systemDictionarytToolbar" fitColumns="true"
		border="1">
		<thead>
			<tr>
	...
	<div id="systemDictionaryDlg" class="easyui-dialog"
		...
		<form id="systemDictionaryForm" class="myform" method="post">
            ...
            idField: 'id',
            textField: 'realName', 
            url: '/systemDictionary/systemDictionaryManager',
            method: 'post',
            columns: [[
